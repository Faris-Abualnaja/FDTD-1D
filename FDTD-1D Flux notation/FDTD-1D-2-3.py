...
# Size of material
mat_start = int(k_max/2)
mat_end   = mat_start + 40
...
const_a[mat_start:mat_end] = (sigma/eps_0)*dt
const_b[mat_start:mat_end] = 1/(eps_r + (sigma/eps_0)*dt)

# Material height across domain: air + some material
material = np.zeros(k_max)
material[:mat_start] = 0
material[mat_start:mat_end] = 1.5
...
with writer.saving(fig, 'Gifs/FDTD-1D-2-3.gif', 100):
    # Time loop
